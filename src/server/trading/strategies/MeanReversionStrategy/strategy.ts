...
export class MeanReversionStrategy extends EventEmitter {
  ...
  // Параметры стратегии
  private readonly CANDLES_COUNT = 4000;
  private readonly CANDLES_COUNT_FOR_BETA = 1000;
  private readonly CANDLES_COUNT_FOR_Z_SCORE = 4000;

  private readonly Z_SCORE_ENTRY = 3.0;
  private readonly Z_SCORE_EXIT = 0.0;
  private readonly Z_SCORE_STOP_LOSS = 8.0;
  ...
  private calculateZScore(): number | null {
