      ...
      for (const symbolB of symbols) {
          ...
          switch (signal.type) {
            case 'open':
              ...
              openTrade = {
                ...
                symbolB,
                quantityA: 1,
                quantityB: 1 / Math.abs(signal.beta),
        ...
        if (openTrade) {
          ...
          const roi = calculateRoi(
            ...
            symbolA,
            symbolB,
            currentOpenTrade.quantityA,
            currentOpenTrade.quantityB,
            currentOpenTrade.openPriceA,
            currentOpenTrade.openPriceB,
            lastPriceA,
            lastPriceB,
          ...
          completeTrades.push({
            ...
            quantityA: currentOpenTrade.quantityA,
            quantityB: currentOpenTrade.quantityB,
